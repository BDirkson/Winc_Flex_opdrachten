/*
Exercise 1:
Write a function testNum that takes a number as an argument and returns a Promise that tests if the value is less than 
or greater than the value 10. Log the result to the console.
*/
...
makeAllCaps(complicatedArray)
    .then(sortWords(complicatedArray))       // het resultaat van de sortWords promises gaat door in de makeAllCaps promise
    .then(result => console.log(result))
    .catch(error => console.log(error));